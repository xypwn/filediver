...
const (
	...
	Tag_Value_10000000000_Len_23   Tag = 0x10000000000
	Tag_Value_20000000000_Len_36   Tag = 0x20000000000
	Tag_Value_40000000000_Len_33   Tag = 0x40000000000
	Tag_Value_80000000000_Len_38   Tag = 0x80000000000
	Tag_Value_100000000000_Len_12  Tag = 0x100000000000
	Tag_Value_200000000000_Len_20  Tag = 0x200000000000
	Tag_Value_400000000000_Len_18  Tag = 0x400000000000
	Tag_Value_800000000000_Len_15  Tag = 0x800000000000
	Tag_Value_1000000000000_Len_15 Tag = 0x1000000000000
)
...
func (p Tag) MarshalText() ([]byte, error) {
	...
	toReturn := ""
	i := Tag_Character
	for i <= Tag_Value_1000000000000_Len_15 {
		if i&p != Tag_None {
			if len(toReturn) > 0 {
				toReturn += "|"
			}
