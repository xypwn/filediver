...
func ConvertBinkToMP4(fileExt string) func(ctx *extractor.Context) error {
	return func(ctx *extractor.Context) error {
		if !ctx.Runner().Has("ffmpeg") {
			return ExtractBink(fileExt)(ctx)
		}
