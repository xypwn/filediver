...
def convert_materials(gltf: Dict, node: Dict, variants: List[Dict], hasVariants: bool, materialTextures: Dict[int, Dict[str, Image]], packall: bool):
    ...
    for primIdx, primitive in enumerate(mesh["primitives"]):
        for varIdx in range(len(variants)):
            ...
            textures = get_textures(bpy.data, gltf, materialTextures, materialIndex, material, loader is not None)
            ...
            for child in object.children:
                ...
                if instance["materials"] != None and len(new_nested_child.material_slots) > 0:
                    ...
                    for slotIdx, materialIdx in instance["materials"].items():
                        ...
                        textures = get_textures(bpy.data, gltf, materialTextures, materialIdx, material, loader is not None)
