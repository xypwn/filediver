...
def create_HD2_Shader(context, operator, group_name, material: Optional[Material] = None, obj: Optional[Object] = None):
    ...
    #Socket Secondary Material LUT
    secondary_material_lut_socket = HD2_Shader.interface.new_socket(name = "Secondary Material LUT", in_out='INPUT', socket_type = 'NodeSocketColor')
    secondary_material_lut_socket.hide_value = True
    #Socket Pattern LUT
    ...
    #Socket Camo Array
    camo_array_socket = HD2_Shader.interface.new_socket(name = "Camo Array", in_out='INPUT', socket_type = 'NodeSocketColor')
    camo_array_socket.default_value = (0.0, 0.0, 0.0, 0.0)
    camo_array_socket.hide_value = True
    #Socket Normal Map_Alpha
    camo_array_alpha_socket = HD2_Shader.interface.new_socket(name = "Camo Array Alpha", in_out='INPUT', socket_type = 'NodeSocketFloat')
    camo_array_alpha_socket.default_value = 0.0
    camo_array_alpha_socket.hide_value = True
    ...
    dynamic_decal_settings_panel = HD2_Shader.interface.new_panel("Dynamic Decal Settings")
    dynamic_decal_settings_panel.default_closed = True
    ...
    decal_id_socket = HD2_Shader.interface.new_socket(name = "decal_id", in_out='INPUT', socket_type = 'NodeSocketInt', parent = dynamic_decal_settings_panel)
    decal_id_socket.default_value = 0
    decal_size_x_socket = HD2_Shader.interface.new_socket(name = "decal_size_x", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_size_x_socket.default_value = 0.0
    decal_size_y_socket = HD2_Shader.interface.new_socket(name = "decal_size_y", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_size_y_socket.default_value = 0.0
    decal_id_offset_x_socket = HD2_Shader.interface.new_socket(name = "decal_id_offset_x", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_id_offset_x_socket.default_value = 0.0
    decal_id_offset_y_socket = HD2_Shader.interface.new_socket(name = "decal_id_offset_y", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_id_offset_y_socket.default_value = 0.0
    use_decal_rgb_channels_socket = HD2_Shader.interface.new_socket(name = "use_decal_rgb_channels", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    use_decal_rgb_channels_socket.default_value = 0.0
    decal_channel_selection_socket = HD2_Shader.interface.new_socket(name = "decal_channel_selection", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_channel_selection_socket.default_value = 0.0
    decal_lut_size_x_socket = HD2_Shader.interface.new_socket(name = "decal_lut_size_x", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_lut_size_x_socket.default_value = 0.0
    decal_lut_size_y_socket = HD2_Shader.interface.new_socket(name = "decal_lut_size_y", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_lut_size_y_socket.default_value = 0.0
    decal_lut_id_socket = HD2_Shader.interface.new_socket(name = "decal_lut_id", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = dynamic_decal_settings_panel)
    decal_lut_id_socket.default_value = 0.0

    
    #sets the detail texture tile size to 1.000 by default
    hd2_shader_group_node.inputs['detail_tile_factor_mult'].default_value = (1.000)
...
#delete warning frames        
    ...
    try:       
        for DeleteFrame06 in material.node_tree.nodes:
            if DeleteFrame06.label == "WARNING!Current texture isnt a Material LUT. Errors may occur->":
                material.node_tree.nodes.remove(material.node_tree.nodes['Secondary Material LUT Warning'])
    except:
        pass
    ...
    try:       
        for DeleteFrame07 in material.node_tree.nodes:
            if DeleteFrame07.label == "WARNING!Current texture must be an EXR file. Errors may occur->":
                material.node_tree.nodes.remove(material.node_tree.nodes['Secondary Material LUT Filetype Warning'])
    except:
        pass
...
#reconnect nodes if they get undone
    ...
    material.node_tree.links.new(material.node_tree.nodes['Reroute.036'].outputs[0], hd2_shader_group_node.inputs['Camo Array'])
    material.node_tree.links.new(material.node_tree.nodes['Reroute.037'].outputs[0], hd2_shader_group_node.inputs['Camo Array Alpha'])
...
#create warnings for user
    ...
    try:
        print("ID Mask = "+IDMaskArrayFiletype,(IDMaskArraySizeX,IDMaskArraySizeY))
    except:
        print("No ID Mask Texture detected")
    ...
    try:
        SecondaryMaterialLUTSizeX = material.node_tree.nodes['Secondary Material LUT Texture'].inputs[0].node.image.size[0]
        SecondaryMaterialLUTSizeY = material.node_tree.nodes['Secondary Material LUT Texture'].inputs[0].node.image.size[1]
    except:
        pass
        
    #get location of primary material lut node    
    SecondaryMaterialLUTLocation = material.node_tree.nodes['Secondary Material LUT Texture'].location
    try:
        if not SecondaryMaterialLUTSizeX == 23 and SecondaryMaterialLUTSizeY == 1:
                #Tell user that the texture isnt a proper Material LUT
                SecondaryMaterialLUTWarning = material.node_tree.nodes.new("NodeFrame")
                SecondaryMaterialLUTWarning.label = "WARNING!Current texture isnt a Material LUT. Errors may occur->"
                SecondaryMaterialLUTWarning.name = "Secondary Material LUT Warning"
                SecondaryMaterialLUTWarning.use_custom_color = True
                SecondaryMaterialLUTWarning.color = (1,0,0)
                SecondaryMaterialLUTWarning.label_size = 20
                SecondaryMaterialLUTWarning.shrink = True
                SecondaryMaterialLUTWarning.location = (SecondaryMaterialLUTLocation.x - 660, SecondaryMaterialLUTLocation.y - 100)
                SecondaryMaterialLUTWarning.height, SecondaryMaterialLUTWarning.width = (50,650)
    except:
        pass

    try:
        SecondaryMaterialLUTFiletype = material.node_tree.nodes['Secondary Material LUT Texture'].image.file_format
        print("Secondary Material LUT = "+SecondaryMaterialLUTFiletype,(SecondaryMaterialLUTSizeX,SecondaryMaterialLUTSizeY))
    except:
        print("No Secondary Material LUT detected")
        
    try:
        if not SecondaryMaterialLUTFiletype == "OPEN_EXR":
            SecondaryMaterialLUTFiletypeWarning = material.node_tree.nodes.new("NodeFrame")
            SecondaryMaterialLUTFiletypeWarning.label = "WARNING!Current texture must be an EXR file. Errors may occur->"
            SecondaryMaterialLUTFiletypeWarning.name = "Secondary Material LUT Filetype Warning"
            SecondaryMaterialLUTFiletypeWarning.use_custom_color = True
            SecondaryMaterialLUTFiletypeWarning.color = (1,0,0)
            SecondaryMaterialLUTFiletypeWarning.label_size = 20
            SecondaryMaterialLUTFiletypeWarning.shrink = True
            SecondaryMaterialLUTFiletypeWarning.location = (SecondaryMaterialLUTLocation.x - 660, SecondaryMaterialLUTLocation.y - 50)
            SecondaryMaterialLUTFiletypeWarning.height, SecondaryMaterialLUTFiletypeWarning.width = (50,650)
    except:
        pass
    ...
    try:
        material.node_tree.nodes['Secondary Material LUT Texture'].label = ("Secondary Material LUT Texture "+"("+str(SecondaryMaterialLUTSizeX)+"x"+str(SecondaryMaterialLUTSizeY)+")"+" "+SecondaryMaterialLUTFiletype)
    except:
        material.node_tree.nodes['Secondary Material LUT Texture'].label = ("Secondary Material LUT Texture")
...
#initialize hd2_shader nodes       
    ...
    #node Secondary Material LUT_12
    secondary_material_lut_12 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_12.label = "Secondary Material LUT_12"
    secondary_material_lut_12.name = "Secondary Material LUT_12"
    secondary_material_lut_12.use_custom_color = True
    secondary_material_lut_12.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_12.extension = 'EXTEND'
    secondary_material_lut_12.image_user.frame_current = 1
    secondary_material_lut_12.image_user.frame_duration = 1
    secondary_material_lut_12.image_user.frame_offset = 87
    secondary_material_lut_12.image_user.frame_start = 1
    secondary_material_lut_12.image_user.tile = 0
    secondary_material_lut_12.image_user.use_auto_refresh = False
    secondary_material_lut_12.image_user.use_cyclic = False
    secondary_material_lut_12.interpolation = 'Closest'
    secondary_material_lut_12.projection = 'FLAT'
    secondary_material_lut_12.projection_blend = 0.0
    ...
    #node Secondary Material LUT_13
    secondary_material_lut_13 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_13.label = "Secondary Material LUT_13"
    secondary_material_lut_13.name = "Secondary Material LUT_13"
    secondary_material_lut_13.use_custom_color = True
    secondary_material_lut_13.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_13.extension = 'EXTEND'
    secondary_material_lut_13.image_user.frame_current = 1
    secondary_material_lut_13.image_user.frame_duration = 1
    secondary_material_lut_13.image_user.frame_offset = 87
    secondary_material_lut_13.image_user.frame_start = 1
    secondary_material_lut_13.image_user.tile = 0
    secondary_material_lut_13.image_user.use_auto_refresh = False
    secondary_material_lut_13.image_user.use_cyclic = False
    secondary_material_lut_13.interpolation = 'Closest'
    secondary_material_lut_13.projection = 'FLAT'
    secondary_material_lut_13.projection_blend = 0.0
    ...
    #node Secondary Material LUT_16
    secondary_material_lut_16 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_16.label = "Secondary Material LUT_16"
    secondary_material_lut_16.name = "Secondary Material LUT_16"
    secondary_material_lut_16.use_custom_color = True
    secondary_material_lut_16.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_16.extension = 'EXTEND'
    secondary_material_lut_16.image_user.frame_current = 1
    secondary_material_lut_16.image_user.frame_duration = 1
    secondary_material_lut_16.image_user.frame_offset = 87
    secondary_material_lut_16.image_user.frame_start = 1
    secondary_material_lut_16.image_user.tile = 0
    secondary_material_lut_16.image_user.use_auto_refresh = False
    secondary_material_lut_16.image_user.use_cyclic = False
    secondary_material_lut_16.interpolation = 'Closest'
    secondary_material_lut_16.projection = 'FLAT'
    secondary_material_lut_16.projection_blend = 0.0
    ...
    #node Secondary Material LUT_14
    secondary_material_lut_14 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_14.label = "Secondary Material LUT_14"
    secondary_material_lut_14.name = "Secondary Material LUT_14"
    secondary_material_lut_14.use_custom_color = True
    secondary_material_lut_14.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_14.extension = 'EXTEND'
    secondary_material_lut_14.image_user.frame_current = 1
    secondary_material_lut_14.image_user.frame_duration = 1
    secondary_material_lut_14.image_user.frame_offset = 87
    secondary_material_lut_14.image_user.frame_start = 1
    secondary_material_lut_14.image_user.tile = 0
    secondary_material_lut_14.image_user.use_auto_refresh = False
    secondary_material_lut_14.image_user.use_cyclic = False
    secondary_material_lut_14.interpolation = 'Closest'
    secondary_material_lut_14.projection = 'FLAT'
    secondary_material_lut_14.projection_blend = 0.0
    ...
    #node Secondary Material LUT_15
    secondary_material_lut_15 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_15.label = "Secondary Material LUT_15"
    secondary_material_lut_15.name = "Secondary Material LUT_15"
    secondary_material_lut_15.use_custom_color = True
    secondary_material_lut_15.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_15.extension = 'EXTEND'
    secondary_material_lut_15.image_user.frame_current = 1
    secondary_material_lut_15.image_user.frame_duration = 1
    secondary_material_lut_15.image_user.frame_offset = 87
    secondary_material_lut_15.image_user.frame_start = 1
    secondary_material_lut_15.image_user.tile = 0
    secondary_material_lut_15.image_user.use_auto_refresh = False
    secondary_material_lut_15.image_user.use_cyclic = False
    secondary_material_lut_15.interpolation = 'Closest'
    secondary_material_lut_15.projection = 'FLAT'
    secondary_material_lut_15.projection_blend = 0.0
    ...
    #node Secondary Material LUT_02
    secondary_material_lut_02 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_02.label = "Secondary Material LUT_02"
    secondary_material_lut_02.name = "Secondary Material LUT_02"
    secondary_material_lut_02.use_custom_color = True
    secondary_material_lut_02.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_02.extension = 'EXTEND'
    secondary_material_lut_02.image_user.frame_current = 1
    secondary_material_lut_02.image_user.frame_duration = 1
    secondary_material_lut_02.image_user.frame_offset = 87
    secondary_material_lut_02.image_user.frame_start = 1
    secondary_material_lut_02.image_user.tile = 0
    secondary_material_lut_02.image_user.use_auto_refresh = False
    secondary_material_lut_02.image_user.use_cyclic = False
    secondary_material_lut_02.interpolation = 'Closest'
    secondary_material_lut_02.projection = 'FLAT'
    secondary_material_lut_02.projection_blend = 0.0
    ...
    #node Secondary Material LUT_03
    secondary_material_lut_03 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_03.label = "Secondary Material LUT_03"
    secondary_material_lut_03.name = "Secondary Material LUT_03"
    secondary_material_lut_03.use_custom_color = True
    secondary_material_lut_03.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_03.extension = 'EXTEND'
    secondary_material_lut_03.image_user.frame_current = 1
    secondary_material_lut_03.image_user.frame_duration = 1
    secondary_material_lut_03.image_user.frame_offset = 87
    secondary_material_lut_03.image_user.frame_start = 1
    secondary_material_lut_03.image_user.tile = 0
    secondary_material_lut_03.image_user.use_auto_refresh = False
    secondary_material_lut_03.image_user.use_cyclic = False
    secondary_material_lut_03.interpolation = 'Closest'
    secondary_material_lut_03.projection = 'FLAT'
    secondary_material_lut_03.projection_blend = 0.0
    ...
    #node Secondary Material LUT_08
    secondary_material_lut_08 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_08.label = "Secondary Material LUT_08"
    secondary_material_lut_08.name = "Secondary Material LUT_08"
    secondary_material_lut_08.use_custom_color = True
    secondary_material_lut_08.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_08.extension = 'EXTEND'
    secondary_material_lut_08.image_user.frame_current = 1
    secondary_material_lut_08.image_user.frame_duration = 1
    secondary_material_lut_08.image_user.frame_offset = 87
    secondary_material_lut_08.image_user.frame_start = 1
    secondary_material_lut_08.image_user.tile = 0
    secondary_material_lut_08.image_user.use_auto_refresh = False
    secondary_material_lut_08.image_user.use_cyclic = False
    secondary_material_lut_08.interpolation = 'Closest'
    secondary_material_lut_08.projection = 'FLAT'
    secondary_material_lut_08.projection_blend = 0.0
    ...
    #node Secondary Material LUT_09
    secondary_material_lut_09 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_09.label = "Secondary Material LUT_09"
    secondary_material_lut_09.name = "Secondary Material LUT_09"
    secondary_material_lut_09.use_custom_color = True
    secondary_material_lut_09.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_09.extension = 'EXTEND'
    secondary_material_lut_09.image_user.frame_current = 1
    secondary_material_lut_09.image_user.frame_duration = 1
    secondary_material_lut_09.image_user.frame_offset = 87
    secondary_material_lut_09.image_user.frame_start = 1
    secondary_material_lut_09.image_user.tile = 0
    secondary_material_lut_09.image_user.use_auto_refresh = False
    secondary_material_lut_09.image_user.use_cyclic = False
    secondary_material_lut_09.interpolation = 'Closest'
    secondary_material_lut_09.projection = 'FLAT'
    secondary_material_lut_09.projection_blend = 0.0
    ...
    #node Secondary Material LUT_10
    secondary_material_lut_10 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_10.label = "Secondary Material LUT_10"
    secondary_material_lut_10.name = "Secondary Material LUT_10"
    secondary_material_lut_10.use_custom_color = True
    secondary_material_lut_10.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_10.extension = 'EXTEND'
    secondary_material_lut_10.image_user.frame_current = 1
    secondary_material_lut_10.image_user.frame_duration = 1
    secondary_material_lut_10.image_user.frame_offset = 87
    secondary_material_lut_10.image_user.frame_start = 1
    secondary_material_lut_10.image_user.tile = 0
    secondary_material_lut_10.image_user.use_auto_refresh = False
    secondary_material_lut_10.image_user.use_cyclic = False
    secondary_material_lut_10.interpolation = 'Closest'
    secondary_material_lut_10.projection = 'FLAT'
    secondary_material_lut_10.projection_blend = 0.0
    ...
    #node Secondary Material LUT_11
    secondary_material_lut_11 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_11.label = "Secondary Material LUT_11"
    secondary_material_lut_11.name = "Secondary Material LUT_11"
    secondary_material_lut_11.use_custom_color = True
    secondary_material_lut_11.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_11.extension = 'EXTEND'
    secondary_material_lut_11.image_user.frame_current = 1
    secondary_material_lut_11.image_user.frame_duration = 1
    secondary_material_lut_11.image_user.frame_offset = 87
    secondary_material_lut_11.image_user.frame_start = 1
    secondary_material_lut_11.image_user.tile = 0
    secondary_material_lut_11.image_user.use_auto_refresh = False
    secondary_material_lut_11.image_user.use_cyclic = False
    secondary_material_lut_11.interpolation = 'Closest'
    secondary_material_lut_11.projection = 'FLAT'
    secondary_material_lut_11.projection_blend = 0.0
...
#get texture for camo array             
    ...
    #node Secondary Material LUT_05
    secondary_material_lut_05 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_05.label = "Secondary Material LUT_05"
    secondary_material_lut_05.name = "Secondary Material LUT_05"
    secondary_material_lut_05.use_custom_color = True
    secondary_material_lut_05.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_05.extension = 'EXTEND'
    secondary_material_lut_05.image_user.frame_current = 1
    secondary_material_lut_05.image_user.frame_duration = 1
    secondary_material_lut_05.image_user.frame_offset = 87
    secondary_material_lut_05.image_user.frame_start = 1
    secondary_material_lut_05.image_user.tile = 0
    secondary_material_lut_05.image_user.use_auto_refresh = False
    secondary_material_lut_05.image_user.use_cyclic = False
    secondary_material_lut_05.interpolation = 'Closest'
    secondary_material_lut_05.projection = 'FLAT'
    secondary_material_lut_05.projection_blend = 0.0
    ...
    #Alpha
    principled_bsdf_001.inputs['Alpha'].default_value = 1.0
    #Weight
    ...
    #node Secondary Material LUT_22
    secondary_material_lut_22 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_22.label = "Secondary Material LUT_22"
    secondary_material_lut_22.name = "Secondary Material LUT_22"
    secondary_material_lut_22.use_custom_color = True
    secondary_material_lut_22.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_22.extension = 'EXTEND'
    secondary_material_lut_22.image_user.frame_current = 1
    secondary_material_lut_22.image_user.frame_duration = 1
    secondary_material_lut_22.image_user.frame_offset = 87
    secondary_material_lut_22.image_user.frame_start = 1
    secondary_material_lut_22.image_user.tile = 0
    secondary_material_lut_22.image_user.use_auto_refresh = False
    secondary_material_lut_22.image_user.use_cyclic = False
    secondary_material_lut_22.interpolation = 'Closest'
    secondary_material_lut_22.projection = 'FLAT'
    secondary_material_lut_22.projection_blend = 0.0
    ...
    #node Secondary Material LUT_17
    secondary_material_lut_17 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_17.label = "Secondary Material LUT_17"
    secondary_material_lut_17.name = "Secondary Material LUT_17"
    secondary_material_lut_17.use_custom_color = True
    secondary_material_lut_17.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_17.extension = 'EXTEND'
    secondary_material_lut_17.image_user.frame_current = 1
    secondary_material_lut_17.image_user.frame_duration = 1
    secondary_material_lut_17.image_user.frame_offset = 87
    secondary_material_lut_17.image_user.frame_start = 1
    secondary_material_lut_17.image_user.tile = 0
    secondary_material_lut_17.image_user.use_auto_refresh = False
    secondary_material_lut_17.image_user.use_cyclic = False
    secondary_material_lut_17.interpolation = 'Closest'
    secondary_material_lut_17.projection = 'FLAT'
    secondary_material_lut_17.projection_blend = 0.0
    ...
    #node Secondary Material LUT_18
    secondary_material_lut_18 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_18.label = "Secondary Material LUT_18"
    secondary_material_lut_18.name = "Secondary Material LUT_18"
    secondary_material_lut_18.use_custom_color = True
    secondary_material_lut_18.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_18.extension = 'EXTEND'
    secondary_material_lut_18.image_user.frame_current = 1
    secondary_material_lut_18.image_user.frame_duration = 1
    secondary_material_lut_18.image_user.frame_offset = 87
    secondary_material_lut_18.image_user.frame_start = 1
    secondary_material_lut_18.image_user.tile = 0
    secondary_material_lut_18.image_user.use_auto_refresh = False
    secondary_material_lut_18.image_user.use_cyclic = False
    secondary_material_lut_18.interpolation = 'Closest'
    secondary_material_lut_18.projection = 'FLAT'
    secondary_material_lut_18.projection_blend = 0.0
    ...
    #node Secondary Material LUT_19
    secondary_material_lut_19 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_19.label = "Secondary Material LUT_19"
    secondary_material_lut_19.name = "Secondary Material LUT_19"
    secondary_material_lut_19.use_custom_color = True
    secondary_material_lut_19.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_19.extension = 'EXTEND'
    secondary_material_lut_19.image_user.frame_current = 1
    secondary_material_lut_19.image_user.frame_duration = 1
    secondary_material_lut_19.image_user.frame_offset = 87
    secondary_material_lut_19.image_user.frame_start = 1
    secondary_material_lut_19.image_user.tile = 0
    secondary_material_lut_19.image_user.use_auto_refresh = False
    secondary_material_lut_19.image_user.use_cyclic = False
    secondary_material_lut_19.interpolation = 'Closest'
    secondary_material_lut_19.projection = 'FLAT'
    secondary_material_lut_19.projection_blend = 0.0
    ...
    #node Secondary Material LUT_20
    secondary_material_lut_20 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_20.label = "Secondary Material LUT_20"
    secondary_material_lut_20.name = "Secondary Material LUT_20"
    secondary_material_lut_20.use_custom_color = True
    secondary_material_lut_20.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_20.extension = 'EXTEND'
    secondary_material_lut_20.image_user.frame_current = 1
    secondary_material_lut_20.image_user.frame_duration = 1
    secondary_material_lut_20.image_user.frame_offset = 87
    secondary_material_lut_20.image_user.frame_start = 1
    secondary_material_lut_20.image_user.tile = 0
    secondary_material_lut_20.image_user.use_auto_refresh = False
    secondary_material_lut_20.image_user.use_cyclic = False
    secondary_material_lut_20.interpolation = 'Closest'
    secondary_material_lut_20.projection = 'FLAT'
    secondary_material_lut_20.projection_blend = 0.0
    ...
    secondary_material_lut_04.label = "Secondary Material LUT_04"
    secondary_material_lut_04.name = "Secondary Material LUT_04"
    secondary_material_lut_04.use_custom_color = True
    secondary_material_lut_04.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_04.extension = 'EXTEND'
    secondary_material_lut_04.image_user.frame_current = 1
    secondary_material_lut_04.image_user.frame_duration = 1
    secondary_material_lut_04.image_user.frame_offset = 87
    secondary_material_lut_04.image_user.frame_start = 1
    secondary_material_lut_04.image_user.tile = 0
    secondary_material_lut_04.image_user.use_auto_refresh = False
    secondary_material_lut_04.image_user.use_cyclic = False
    secondary_material_lut_04.interpolation = 'Closest'
    secondary_material_lut_04.projection = 'FLAT'
    secondary_material_lut_04.projection_blend = 0.0
    ...
    #node Secondary Material LUT_01
    secondary_material_lut_01 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_01.label = "Secondary Material LUT_01"
    secondary_material_lut_01.name = "Secondary Material LUT_01"
    secondary_material_lut_01.use_custom_color = True
    secondary_material_lut_01.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_01.extension = 'EXTEND'
    secondary_material_lut_01.image_user.frame_current = 1
    secondary_material_lut_01.image_user.frame_duration = 1
    secondary_material_lut_01.image_user.frame_offset = 87
    secondary_material_lut_01.image_user.frame_start = 1
    secondary_material_lut_01.image_user.tile = 0
    secondary_material_lut_01.image_user.use_auto_refresh = False
    secondary_material_lut_01.image_user.use_cyclic = False
    secondary_material_lut_01.interpolation = 'Closest'
    secondary_material_lut_01.projection = 'FLAT'
    secondary_material_lut_01.projection_blend = 0.0
    ...
    #node Secondary Material LUT_21
    secondary_material_lut_21 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_21.label = "Secondary Material LUT_21"
    secondary_material_lut_21.name = "Secondary Material LUT_21"
    secondary_material_lut_21.use_custom_color = True
    secondary_material_lut_21.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_21.extension = 'EXTEND'
    secondary_material_lut_21.image_user.frame_current = 1
    secondary_material_lut_21.image_user.frame_duration = 1
    secondary_material_lut_21.image_user.frame_offset = 87
    secondary_material_lut_21.image_user.frame_start = 1
    secondary_material_lut_21.image_user.tile = 0
    secondary_material_lut_21.image_user.use_auto_refresh = False
    secondary_material_lut_21.image_user.use_cyclic = False
    secondary_material_lut_21.interpolation = 'Closest'
    secondary_material_lut_21.projection = 'FLAT'
    secondary_material_lut_21.projection_blend = 0.0
    ...
    #node Secondary Material LUT_00
    secondary_material_lut_00 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_00.label = "Secondary Material LUT_00"
    secondary_material_lut_00.name = "Secondary Material LUT_00"
    secondary_material_lut_00.use_custom_color = True
    secondary_material_lut_00.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_00.extension = 'EXTEND'
    secondary_material_lut_00.image_user.frame_current = 1
    secondary_material_lut_00.image_user.frame_duration = 1
    secondary_material_lut_00.image_user.frame_offset = 87
    secondary_material_lut_00.image_user.frame_start = 1
    secondary_material_lut_00.image_user.tile = 0
    secondary_material_lut_00.image_user.use_auto_refresh = False
    secondary_material_lut_00.image_user.use_cyclic = False
    secondary_material_lut_00.interpolation = 'Closest'
    secondary_material_lut_00.projection = 'FLAT'
    secondary_material_lut_00.projection_blend = 0.0
        
    #node Secondary Material LUT_07
    secondary_material_lut_07 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_07.label = "Secondary Material LUT_07"
    secondary_material_lut_07.name = "Secondary Material LUT_07"
    secondary_material_lut_07.use_custom_color = True
    secondary_material_lut_07.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_07.extension = 'EXTEND'
    secondary_material_lut_07.image_user.frame_current = 1
    secondary_material_lut_07.image_user.frame_duration = 1
    secondary_material_lut_07.image_user.frame_offset = 87
    secondary_material_lut_07.image_user.frame_start = 1
    secondary_material_lut_07.image_user.tile = 0
    secondary_material_lut_07.image_user.use_auto_refresh = False
    secondary_material_lut_07.image_user.use_cyclic = False
    secondary_material_lut_07.interpolation = 'Closest'
    secondary_material_lut_07.projection = 'FLAT'
    secondary_material_lut_07.projection_blend = 0.0
...
#        pass
    ...
    #node Secondary Material LUT_06
    secondary_material_lut_06 = HD2_Shader.nodes.new("ShaderNodeTexImage")
    secondary_material_lut_06.label = "Secondary Material LUT_06"
    secondary_material_lut_06.name = "Secondary Material LUT_06"
    secondary_material_lut_06.use_custom_color = True
    secondary_material_lut_06.color = (0.0, 0.6000000238418579, 0.6000000238418579)
    secondary_material_lut_06.extension = 'EXTEND'
    secondary_material_lut_06.image_user.frame_current = 1
    secondary_material_lut_06.image_user.frame_duration = 1
    secondary_material_lut_06.image_user.frame_offset = 87
    secondary_material_lut_06.image_user.frame_start = 1
    secondary_material_lut_06.image_user.tile = 0
    secondary_material_lut_06.image_user.use_auto_refresh = False
    secondary_material_lut_06.image_user.use_cyclic = False
    secondary_material_lut_06.interpolation = 'Closest'
    secondary_material_lut_06.projection = 'FLAT'
    secondary_material_lut_06.projection_blend = 0.0
    ...
    secondary_material_lut_12.parent = frame_037
    primary_material_lut_13.parent = frame_038
    secondary_material_lut_13.parent = frame_038
    ...
    secondary_material_lut_16.parent = frame_041
    ...
    secondary_material_lut_14.parent = frame_039
    ...
    secondary_material_lut_15.parent = frame_040
    ...
    secondary_material_lut_02.parent = frame_027
    combine_xyz_058.parent = frame_028
    primary_material_lut_03.parent = frame_028
    secondary_material_lut_03.parent = frame_028
    ...
    secondary_material_lut_08.parent = frame_033
    ...
    secondary_material_lut_09.parent = frame_034
    ...
    secondary_material_lut_10.parent = frame_035
    mix_053.parent = frame_036
    mix_054.parent = frame_036
    secondary_material_lut_11.parent = frame_036
    ...
    secondary_material_lut_05.parent = frame_030
    ...
    secondary_material_lut_22.parent = frame_047
    ...
    secondary_material_lut_17.parent = frame_042
    primary_material_lut_18.parent = frame_043
    secondary_material_lut_18.parent = frame_043
    primary_material_lut_19.parent = frame_044
    secondary_material_lut_19.parent = frame_044
    ...
    secondary_material_lut_20.parent = frame_045
    ...
    secondary_material_lut_04.parent = frame_029
    ...
    secondary_material_lut_01.parent = frame_026
    ...
    secondary_material_lut_21.parent = frame_046
    primary_material_lut_00.parent = frame_025
    secondary_material_lut_00.parent = frame_025
    secondary_material_lut_07.parent = frame_032
    ...
    secondary_material_lut_06.parent = frame_031
    ...
    secondary_material_lut_12.location = (-128.0, -93.0)
    primary_material_lut_13.location = (-128.0, 187.0)
    secondary_material_lut_13.location = (-128.0, -93.0)
    ...
    secondary_material_lut_16.location = (-128.0, -93.0)
    ...
    secondary_material_lut_14.location = (-128.0, -93.0)
    ...
    secondary_material_lut_15.location = (-128.0, -93.0)
    ...
    secondary_material_lut_02.location = (-128.0, -93.0)
    combine_xyz_058.location = (-288.0, 187.0)
    primary_material_lut_03.location = (-128.0, 187.0)
    secondary_material_lut_03.location = (-128.0, -93.0)
    ...
    secondary_material_lut_08.location = (-128.0, -93.0)
    ...
    secondary_material_lut_09.location = (-128.0, -93.0)
    ...
    secondary_material_lut_10.location = (-128.0, -93.0)
    mix_053.location = (152.0, 187.0)
    mix_054.location = (152.0, -33.0)
    secondary_material_lut_11.location = (-128.0, -93.0)
    ...
    gamma_007.location = (49820.0, 2020.0)
    vector_math_119.location = (49660.0, 1734.0)
    mix_079.location = (49980.0, 2020.0)
    math_188.location = (49980.0, 1808.0)
    vector_math_120.location = (50140.0, 2020.0)
    vector_math_121.location = (50300.0, 2020.0)
    vector_math_122.location = (50460.0, 2020.0)
    mix_080.location = (50620.0, 2020.0)
    vector_math_123.location = (50780.0, 2020.0)
    ...
    secondary_material_lut_05.location = (-128.0, -93.0)
    ...
    secondary_material_lut_22.location = (-128.0, -93.0)
    ...
    secondary_material_lut_17.location = (-128.0, -93.0)
    primary_material_lut_18.location = (-128.0, 187.0)
    secondary_material_lut_18.location = (-128.0, -93.0)
    primary_material_lut_19.location = (-128.0, 187.0)
    secondary_material_lut_19.location = (-128.0, -93.0)
    ...
    secondary_material_lut_20.location = (-128.0, -93.0)
    ...
    secondary_material_lut_04.location = (-128.0, -93.0)
    ...
    secondary_material_lut_01.location = (-128.0, -93.0)
    ...
    secondary_material_lut_21.location = (-128.0, -93.0)
    primary_material_lut_00.location = (-128.0, 187.0)
    secondary_material_lut_00.location = (-128.0, -93.0)
    secondary_material_lut_07.location = (-128.0, -93.0)
    ...
    secondary_material_lut_06.location = (-128.0, -93.0)
    ...
    #mix_070.Result -> combine_xyz_006.Z
    ...
    HD2_Shader.links.new(mix_1.outputs['Result'], mix_077.inputs['A'])

    HD2_Shader.links.new(mix_017.outputs['Result'], mix_020.inputs['A'])

    HD2_Shader.links.new(mix_006.outputs['Result'], mix_022.inputs['A'])
    ...
    HD2_Shader.links.new(dynamic_decals.outputs['r12.y'], mix_022.inputs['B'])
    HD2_Shader.links.new(dynamic_decals.outputs['r13.x'], mix_020.inputs['B'])
    ...
    HD2_Shader.links.new(vector_math_069.outputs[0], principled_bsdf_001.inputs[0])
    ...
    #combine_xyz_053.Vector -> secondary_material_lut_00.Vector
    HD2_Shader.links.new(combine_xyz_053.outputs[0], secondary_material_lut_00.inputs[0])
    ...
    #secondary_material_lut_00.Color -> mix_032.B
    HD2_Shader.links.new(secondary_material_lut_00.outputs[0], mix_032.inputs[7])
    #secondary_material_lut_00.Alpha -> mix_031.B
    HD2_Shader.links.new(secondary_material_lut_00.outputs[1], mix_031.inputs[3])
    ...
    #combine_xyz_055.Vector -> secondary_material_lut_01.Vector
    HD2_Shader.links.new(combine_xyz_055.outputs[0], secondary_material_lut_01.inputs[0])
    ...
    #secondary_material_lut_01.Color -> mix_033.B
    HD2_Shader.links.new(secondary_material_lut_01.outputs[0], mix_033.inputs[7])
    #secondary_material_lut_01.Alpha -> mix_034.B
    HD2_Shader.links.new(secondary_material_lut_01.outputs[1], mix_034.inputs[3])
    ...
    #combine_xyz_057.Vector -> secondary_material_lut_02.Vector
    HD2_Shader.links.new(combine_xyz_057.outputs[0], secondary_material_lut_02.inputs[0])
    ...
    #secondary_material_lut_02.Color -> mix_035.B
    HD2_Shader.links.new(secondary_material_lut_02.outputs[0], mix_035.inputs[7])
    #secondary_material_lut_02.Alpha -> mix_036.B
    HD2_Shader.links.new(secondary_material_lut_02.outputs[1], mix_036.inputs[3])
    ...
    #combine_xyz_059.Vector -> secondary_material_lut_03.Vector
    HD2_Shader.links.new(combine_xyz_059.outputs[0], secondary_material_lut_03.inputs[0])
    ...
    #secondary_material_lut_03.Color -> mix_037.B
    HD2_Shader.links.new(secondary_material_lut_03.outputs[0], mix_037.inputs[7])
    #secondary_material_lut_03.Alpha -> mix_038.B
    HD2_Shader.links.new(secondary_material_lut_03.outputs[1], mix_038.inputs[3])
    ...
    #combine_xyz_061.Vector -> secondary_material_lut_04.Vector
    HD2_Shader.links.new(combine_xyz_061.outputs[0], secondary_material_lut_04.inputs[0])
    ...
    #secondary_material_lut_04.Color -> mix_039.B
    HD2_Shader.links.new(secondary_material_lut_04.outputs[0], mix_039.inputs[7])
    #secondary_material_lut_04.Alpha -> mix_040.B
    HD2_Shader.links.new(secondary_material_lut_04.outputs[1], mix_040.inputs[3])
    ...
    #combine_xyz_063.Vector -> secondary_material_lut_05.Vector
    HD2_Shader.links.new(combine_xyz_063.outputs[0], secondary_material_lut_05.inputs[0])
    ...
    #secondary_material_lut_05.Color -> mix_041.B
    HD2_Shader.links.new(secondary_material_lut_05.outputs[0], mix_041.inputs[7])
    #secondary_material_lut_05.Alpha -> mix_042.B
    HD2_Shader.links.new(secondary_material_lut_05.outputs[1], mix_042.inputs[3])
    ...
    #combine_xyz_065.Vector -> secondary_material_lut_06.Vector
    HD2_Shader.links.new(combine_xyz_065.outputs[0], secondary_material_lut_06.inputs[0])
    ...
    #secondary_material_lut_06.Color -> mix_043.B
    HD2_Shader.links.new(secondary_material_lut_06.outputs[0], mix_043.inputs[7])
    #secondary_material_lut_06.Alpha -> mix_044.B
    HD2_Shader.links.new(secondary_material_lut_06.outputs[1], mix_044.inputs[3])
    ...
    #combine_xyz_067.Vector -> secondary_material_lut_07.Vector
    HD2_Shader.links.new(combine_xyz_067.outputs[0], secondary_material_lut_07.inputs[0])
    ...
    #secondary_material_lut_07.Color -> mix_045.B
    HD2_Shader.links.new(secondary_material_lut_07.outputs[0], mix_045.inputs[7])
    #secondary_material_lut_07.Alpha -> mix_046.B
    HD2_Shader.links.new(secondary_material_lut_07.outputs[1], mix_046.inputs[3])
    ...
    #combine_xyz_069.Vector -> secondary_material_lut_08.Vector
    HD2_Shader.links.new(combine_xyz_069.outputs[0], secondary_material_lut_08.inputs[0])
    ...
    #secondary_material_lut_08.Color -> mix_047.B
    HD2_Shader.links.new(secondary_material_lut_08.outputs[0], mix_047.inputs[7])
    #secondary_material_lut_08.Alpha -> mix_048.B
    HD2_Shader.links.new(secondary_material_lut_08.outputs[1], mix_048.inputs[3])
    ...
    #combine_xyz_071.Vector -> secondary_material_lut_09.Vector
    HD2_Shader.links.new(combine_xyz_071.outputs[0], secondary_material_lut_09.inputs[0])
    ...
    #secondary_material_lut_09.Color -> mix_049.B
    HD2_Shader.links.new(secondary_material_lut_09.outputs[0], mix_049.inputs[7])
    #secondary_material_lut_09.Alpha -> mix_050.B
    HD2_Shader.links.new(secondary_material_lut_09.outputs[1], mix_050.inputs[3])
    ...
    #combine_xyz_073.Vector -> secondary_material_lut_10.Vector
    HD2_Shader.links.new(combine_xyz_073.outputs[0], secondary_material_lut_10.inputs[0])
    ...
    #secondary_material_lut_10.Color -> mix_051.B
    HD2_Shader.links.new(secondary_material_lut_10.outputs[0], mix_051.inputs[7])
    #secondary_material_lut_10.Alpha -> mix_052.B
    HD2_Shader.links.new(secondary_material_lut_10.outputs[1], mix_052.inputs[3])
    ...
    #combine_xyz_075.Vector -> secondary_material_lut_11.Vector
    HD2_Shader.links.new(combine_xyz_075.outputs[0], secondary_material_lut_11.inputs[0])
    ...
    #secondary_material_lut_11.Color -> mix_053.B
    HD2_Shader.links.new(secondary_material_lut_11.outputs[0], mix_053.inputs[7])
    #secondary_material_lut_11.Alpha -> mix_054.B
    HD2_Shader.links.new(secondary_material_lut_11.outputs[1], mix_054.inputs[3])
    ...
    #combine_xyz_077.Vector -> secondary_material_lut_12.Vector
    HD2_Shader.links.new(combine_xyz_077.outputs[0], secondary_material_lut_12.inputs[0])
    ...
    #secondary_material_lut_12.Color -> mix_055.B
    HD2_Shader.links.new(secondary_material_lut_12.outputs[0], mix_055.inputs[7])
    #secondary_material_lut_12.Alpha -> mix_056.B
    HD2_Shader.links.new(secondary_material_lut_12.outputs[1], mix_056.inputs[3])
    ...
    #combine_xyz_079.Vector -> secondary_material_lut_13.Vector
    HD2_Shader.links.new(combine_xyz_079.outputs[0], secondary_material_lut_13.inputs[0])
    ...
    #secondary_material_lut_13.Color -> mix_057.B
    HD2_Shader.links.new(secondary_material_lut_13.outputs[0], mix_057.inputs[7])
    #secondary_material_lut_13.Alpha -> mix_058.B
    HD2_Shader.links.new(secondary_material_lut_13.outputs[1], mix_058.inputs[3])
    ...
    #combine_xyz_080.Vector -> secondary_material_lut_14.Vector
    HD2_Shader.links.new(combine_xyz_080.outputs[0], secondary_material_lut_14.inputs[0])
    ...
    #secondary_material_lut_14.Color -> mix_059.B
    HD2_Shader.links.new(secondary_material_lut_14.outputs[0], mix_059.inputs[7])
    #secondary_material_lut_14.Alpha -> mix_060.B
    HD2_Shader.links.new(secondary_material_lut_14.outputs[1], mix_060.inputs[3])
    ...
    #combine_xyz_082.Vector -> secondary_material_lut_15.Vector
    HD2_Shader.links.new(combine_xyz_082.outputs[0], secondary_material_lut_15.inputs[0])
    ...
    #secondary_material_lut_15.Color -> mix_061.B
    HD2_Shader.links.new(secondary_material_lut_15.outputs[0], mix_061.inputs[7])
    #secondary_material_lut_15.Alpha -> mix_062.B
    HD2_Shader.links.new(secondary_material_lut_15.outputs[1], mix_062.inputs[3])
    ...
    #combine_xyz_084.Vector -> secondary_material_lut_16.Vector
    HD2_Shader.links.new(combine_xyz_084.outputs[0], secondary_material_lut_16.inputs[0])
    ...
    #secondary_material_lut_16.Color -> mix_063.B
    HD2_Shader.links.new(secondary_material_lut_16.outputs[0], mix_063.inputs[7])
    #secondary_material_lut_16.Alpha -> mix_064.B
    HD2_Shader.links.new(secondary_material_lut_16.outputs[1], mix_064.inputs[3])
    ...
    #combine_xyz_086.Vector -> secondary_material_lut_17.Vector
    HD2_Shader.links.new(combine_xyz_086.outputs[0], secondary_material_lut_17.inputs[0])
    ...
    #secondary_material_lut_17.Color -> mix_065.B
    HD2_Shader.links.new(secondary_material_lut_17.outputs[0], mix_065.inputs[7])
    #secondary_material_lut_17.Alpha -> mix_066.B
    HD2_Shader.links.new(secondary_material_lut_17.outputs[1], mix_066.inputs[3])
    ...
    #combine_xyz_088.Vector -> secondary_material_lut_18.Vector
    HD2_Shader.links.new(combine_xyz_088.outputs[0], secondary_material_lut_18.inputs[0])
    ...
    #secondary_material_lut_18.Color -> mix_067.B
    HD2_Shader.links.new(secondary_material_lut_18.outputs[0], mix_067.inputs[7])
    #secondary_material_lut_18.Alpha -> mix_068.B
    HD2_Shader.links.new(secondary_material_lut_18.outputs[1], mix_068.inputs[3])
    ...
    #combine_xyz_090.Vector -> secondary_material_lut_19.Vector
    HD2_Shader.links.new(combine_xyz_090.outputs[0], secondary_material_lut_19.inputs[0])
    ...
    #secondary_material_lut_19.Color -> mix_069.B
    HD2_Shader.links.new(secondary_material_lut_19.outputs[0], mix_069.inputs[7])
    #secondary_material_lut_19.Alpha -> mix_070.B
    HD2_Shader.links.new(secondary_material_lut_19.outputs[1], mix_070.inputs[3])
    ...
    #combine_xyz_092.Vector -> secondary_material_lut_20.Vector
    HD2_Shader.links.new(combine_xyz_092.outputs[0], secondary_material_lut_20.inputs[0])
    ...
    #secondary_material_lut_20.Color -> mix_071.B
    HD2_Shader.links.new(secondary_material_lut_20.outputs[0], mix_071.inputs[7])
    #secondary_material_lut_20.Alpha -> mix_072.B
    HD2_Shader.links.new(secondary_material_lut_20.outputs[1], mix_072.inputs[3])
    ...
    #combine_xyz_094.Vector -> secondary_material_lut_21.Vector
    HD2_Shader.links.new(combine_xyz_094.outputs[0], secondary_material_lut_21.inputs[0])
    ...
    #secondary_material_lut_21.Color -> mix_073.B
    HD2_Shader.links.new(secondary_material_lut_21.outputs[0], mix_073.inputs[7])
    #secondary_material_lut_21.Alpha -> mix_074.B
    HD2_Shader.links.new(secondary_material_lut_21.outputs[1], mix_074.inputs[3])
    ...
    #combine_xyz_096.Vector -> secondary_material_lut_22.Vector
    HD2_Shader.links.new(combine_xyz_096.outputs[0], secondary_material_lut_22.inputs[0])
    ...
    #secondary_material_lut_22.Color -> mix_075.B
    HD2_Shader.links.new(secondary_material_lut_22.outputs[0], mix_075.inputs[7])
    #secondary_material_lut_22.Alpha -> mix_076.B
    HD2_Shader.links.new(secondary_material_lut_22.outputs[1], mix_076.inputs[3])
    ...
    #separate_xyz_025.Y -> math_236.Value
    HD2_Shader.links.new(separate_xyz_025.outputs[1], math_236.inputs[0])
    #math_236.Value -> Slot1and2.Factor
    HD2_Shader.links.new(math_236.outputs[0], Slot1and2.inputs[0])
    #separate_xyz_025.Z -> math_237.Value
    HD2_Shader.links.new(separate_xyz_025.outputs[2], math_237.inputs[0])
...
def update_images(HD2_Shader: NodeTree, material: Material):
    ...
    #Get Secondary Material LUT from external texture node for shader repetition
    secondary_lut_image = node_tree.nodes["Secondary Material LUT Texture"].image

    decal_texture_image = node_tree.nodes["Decal Texture"].image
    ...
    for node in secondary_material_luts:
        node.image = secondary_lut_image

    for node in decal_sheets:
        node.image = decal_texture_image

    decal_pixels: ShaderNodeCombineXYZ = HD2_Shader.nodes["Decal Offsetting"].node_tree.nodes["Decal Texture Size"]

    drv_x = decal_pixels.inputs['X'].driver_add("default_value")
    if "var" in drv_x.driver.variables:
        var_x = drv_x.driver.variables["var"]
    else:
        var_x = drv_x.driver.variables.new()
    var_x.name = "var"
    var_x.type = 'SINGLE_PROP'
    target_x = var_x.targets[0]
    target_x.id_type = 'IMAGE'
    target_x.id = decal_texture_image
    target_x.data_path = "size[0]"
    drv_x.driver.expression = "var"

    drv_y = decal_pixels.inputs['Y'].driver_add("default_value")
    if "var" in drv_y.driver.variables:
        var_y = drv_y.driver.variables["var"]
    else:
        var_y = drv_y.driver.variables.new()
    var_y.name = "var"
    var_y.type = 'SINGLE_PROP'
    target_y = var_y.targets[0]
    target_y.id_type = 'IMAGE'
    target_y.id = decal_texture_image
    target_y.data_path = "size[1]"
    drv_y.driver.expression = "var"
...
class NODE2(bpy.types.Operator):
    bl_label = ("Update Images")
    bl_idname = "node.update_operator"

    def execute(self, context):
        custom_node_name = get_current_material_name() + ScriptVersion
        GroupNode = bpy.data.node_groups[custom_node_name]
        update_images(GroupNode, bpy.context.active_object.active_material)
